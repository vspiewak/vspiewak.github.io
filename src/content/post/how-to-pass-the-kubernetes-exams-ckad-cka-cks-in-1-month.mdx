...
* [CKS - Certified Kubernetes Security Specialist](https://www.credly.com/badges/77c4829d-0372-4ff4-96e4-e3d091761057) on March 14

![CKAD, CKA and CKS badges issued by The Linux Foundation — the three Kubernetes certifications, passed in one month](~/assets/images/post/how-to-pass-the-kubernetes-exams-ckad-cka-cks-in-1-month/badges.png)
...
If you succeed to obtain a score of 75 or more, you should be fine at the exam.
...
Be able to verify your answers is a really good exercise during the training phase.
...
On my side, I automated the whole thing with Ansible in [vspiewak/k8s-playground](https://github.com/vspiewak/k8s-playground) : a kubeadm cluster on AWS EC2, and my notes for each CKS topic.
The packages versions are pinned *slightly* outdated on purpose, so you can practice a cluster upgrade on it 😉
